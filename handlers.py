...
async def cmd_start(message: Message) -> None:
    ...
    if not _is_allowed(user_id):
        ...
        return
    await message.answer(
        "Привет, Владимир! 👋 Я твой ассистент на базе Claude.\n\n"
        "Просто пиши мне — отвечу и буду помнить наш разговор.\n"
...
async def cmd_help(message: Message) -> None:
    await message.answer(
        "Я личный ассистент на Claude. Умею общаться, помогать с идеями, "
        "текстами, кодом, планированием.\n\n"
